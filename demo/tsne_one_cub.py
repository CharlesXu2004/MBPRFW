    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(test_loader):
            ...
            for i in range(result.shape[0]):
                if i == 0:
                    plt.scatter(result[i, 0], result[i, 1], marker="^", s=100,
                                c='k', alpha=1, label='真实的原型')
                elif i == 1:
                    plt.scatter(result[i, 0], result[i, 1], marker="p", s=100,
                                c='k', alpha=1, label='校正后的原型')
                elif i == 2:
                    plt.scatter(result[i, 0], result[i, 1], marker="s", s=100,
