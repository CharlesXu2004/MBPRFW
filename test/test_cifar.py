...
if __name__ == '__main__':
    ...
    if args.pretrain:
        #path = '/home/rugu/PycharmProjects/few-shot/save/' + args.model + args.backbone + 'CIFAR_0.05' + '/'
        #path = '/home/rugu/PycharmProjects/few-shot/save/cifar_maxacc/'
        path = '/home/rugu/桌面/model/cifar/base/'
        #path = '/media/rugu/KINGSTON/cifar/'
        #path = '/media/rugu/新加卷/model/CIFAR_base/'

        model_path = path +'64.pth'
    ...
    with torch.no_grad():
        ...
        #     # feature_copy = maxminnorm(feature_copy)
            feature_copy = np.power(feature_copy[:, ], 0.8)
