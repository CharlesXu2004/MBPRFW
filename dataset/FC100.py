...
class FC100(Dataset):
    ...
    def __init__(self, setname, image_size, aug, transform=None):
        ...
        dataset_path = ROOT_PATH + setname
        ...
        for label in os.listdir(dataset_path):
            images_path = dataset_path + '/' + label + '/'
            # print(images_path)
            self.wnids.append(label)
    ...
    def __getitem__(self, i):
        ...
        if self.aug:
            ...
            image_1 = transforms.functional.resized_crop(image_1, np.random.randint(28), np.random.randint(28), 56, 56,
                                                         (84, 84))
