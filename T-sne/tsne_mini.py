...
if __name__ == '__main__':
    ...
    if args.pretrain:
        ...
        path = 'C:/Users/13624/Desktop/few-shot - som/save/model/mini/rotation/'
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(test_loader):
            ...
            plt.title("")
            plt.savefig('C:/Users/13624/Desktop/few-shot - som/save/model/mini/rotation/mini_tsne_4.jpeg',format='jpeg')
            plt.show()
            break
