...
if __name__ == '__main__':
    ...
    if args.dataset == 'CIFAR':
        ...
        trainset = CIFAR('train', image_size, False)   #LiFeiFan
        base_class = 64
    ...
    if args.pretrain:
        ...
        #path = '/home/rugu/PycharmProjects/few-shot/save/cifar_maxacc/'
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(test_loader):
            ...
            plt.scatter(result[0, 0], result[0, 1], marker="^", s=120,
                        c=plt.cm.Set1(1.0 / 8.0), alpha=1, label='true prototype')

            plt.scatter(result[1, 0], result[1, 1], marker="p", s=120,
                        c=plt.cm.Set1(2.0 / 8.0), alpha=1, label='refined prototype')

            plt.scatter(result[2, 0], result[2, 1], marker="s", s=120,
                        c=plt.cm.Set1(3.0 / 8.0), alpha=1, label='prototype')

            plt.scatter(result[3:, 0], result[3:, 1], marker='o', s=10,
                        c=plt.cm.Set1(4.0 / 8.0), alpha=1, label='sample features')
            ...
            plt.title("")
            plt.savefig('/home/rugu/桌面/cifar_tsne.jpeg', format='jpeg')
            plt.show()
            break
